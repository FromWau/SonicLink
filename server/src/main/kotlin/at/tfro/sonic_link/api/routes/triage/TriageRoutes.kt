...
import at.tfro.sonic_link.api.routes.triage.model.Artist
...
import at.tfro.sonic_link.api.routes.triage.model.Recording
                ...
                val mappings = musicbrainzApi.search(
                    ...
                    Recording(
                        ...
                        artistCredit = it.artistCredit.map { ac ->
                            at.tfro.sonic_link.api.routes.triage.model.ArtistCredit(
                                name = ac.name,
                                artist = Artist(
                                    id = ac.artist.id,
                                    name = ac.artist.name,
