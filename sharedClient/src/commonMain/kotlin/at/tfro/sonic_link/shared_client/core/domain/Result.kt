package at.tfro.sonic_link.shared_client.core.domain

sealed interface Result<out T, out E : Error> {
    data class Success<out T>(val data: T) : Result<T, Nothing>
    data class Error<out E : at.tfro.sonic_link.shared_client.core.domain.Error>(val error: E) : Result<Nothing, E>
}
